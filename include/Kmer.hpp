...
template <typename R> static constexpr R makeBitmask(unsigned int const onecount) {
  return (onecount == 0)
             ? 0
...
static const constexpr uint64_t maskTable[] = {
    makeBitmask<uint64_t>(0),  makeBitmask<uint64_t>(2),  makeBitmask<uint64_t>(4),
    makeBitmask<uint64_t>(6),  makeBitmask<uint64_t>(8),  makeBitmask<uint64_t>(10),
    makeBitmask<uint64_t>(12), makeBitmask<uint64_t>(14), makeBitmask<uint64_t>(16),
    makeBitmask<uint64_t>(18), makeBitmask<uint64_t>(20), makeBitmask<uint64_t>(22),
    makeBitmask<uint64_t>(24), makeBitmask<uint64_t>(26), makeBitmask<uint64_t>(28),
    makeBitmask<uint64_t>(30), makeBitmask<uint64_t>(32), makeBitmask<uint64_t>(34),
    makeBitmask<uint64_t>(36), makeBitmask<uint64_t>(38), makeBitmask<uint64_t>(40),
    makeBitmask<uint64_t>(42), makeBitmask<uint64_t>(44), makeBitmask<uint64_t>(46),
    makeBitmask<uint64_t>(48), makeBitmask<uint64_t>(50), makeBitmask<uint64_t>(52),
    makeBitmask<uint64_t>(54), makeBitmask<uint64_t>(56), makeBitmask<uint64_t>(58),
    makeBitmask<uint64_t>(60), makeBitmask<uint64_t>(62)};
